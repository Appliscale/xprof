...
/***/ function(module, exports, __webpack_require__) {
	...
	var CallsTracer = function (_React$Component) {
	  ...
	  _createClass(CallsTracer, [{
	    ...
	    value: function () {
	      function handleRowExpandClick(ref, e) {
	        e.preventDefault();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tracing_switch = __webpack_require__(22);

	var _tracing_switch2 = _interopRequireDefault(_tracing_switch);

	var _graph_panel = __webpack_require__(23);

	var _graph_panel2 = _interopRequireDefault(_graph_panel);

	var _function_browser = __webpack_require__(24);
	    ...
	    value: function () {
	      function getTracingStatus() {
	        ...
	        $.ajax({ url: "/api/trace_status" }).done(function (data) {
	          ...
	          _this3.state.timeout = window.setTimeout(_this3.getTracingStatus.bind(_this3), 1000);
